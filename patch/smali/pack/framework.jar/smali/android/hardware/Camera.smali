...
.field private static final CAMERA_MSG_GESTURE:I = 0x4000

.field private static final CAMERA_MSG_GESTURE_DETECTION:I = 0x20000

.field private static final CAMERA_MSG_META_DATA:I = 0x2000

.field private static final CAMERA_MSG_NOTIFY_CONTINUOUS_SHOT:I = 0x8000
...
.field private static final CAMERA_MSG_SCENE_DETECTION:I = 0x10000
...
.method constructor <init>(I)V
    ...
    .line 190
    new-instance v2, Landroid/hardware/Camera$GestureEvent;

    invoke-direct {v2, p0}, Landroid/hardware/Camera$GestureEvent;-><init>(Landroid/hardware/Camera;)V

    iput-object v2, p0, Landroid/hardware/Camera;->mGestureEvent:Landroid/hardware/Camera$GestureEvent;
...
.method static synthetic access$1000(Landroid/hardware/Camera;)Z
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$1200(Landroid/hardware/Camera;ZZ)V
    .locals 0
    .param p0, "x0"    # Landroid/hardware/Camera;
    .param p1, "x1"    # Z
    .param p2, "x2"    # Z
...
.method static synthetic access$1300(Landroid/hardware/Camera;)Landroid/hardware/Camera$PictureCallback;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$1400(Landroid/hardware/Camera;)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$1500(Landroid/hardware/Camera;)Landroid/hardware/Camera$AutoFocusCallback;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$1600(Landroid/hardware/Camera;)Landroid/hardware/Camera$OnZoomChangeListener;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$1700(Landroid/hardware/Camera;)Landroid/hardware/Camera$FaceDetectionListener;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$1800(Landroid/hardware/Camera;)Landroid/hardware/Camera$ErrorCallback;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$1900(Landroid/hardware/Camera;)Landroid/hardware/Camera$AutoFocusMoveCallback;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$200(Landroid/hardware/Camera;)Landroid/hardware/Camera$ContinuousShotDone;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$2000(Landroid/hardware/Camera;)Landroid/hardware/Camera$CameraDataCallback;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$2100(Landroid/hardware/Camera;)Landroid/hardware/Camera$CameraMetaDataCallback;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$300(Landroid/hardware/Camera;)Landroid/hardware/Camera$GestureEventCallback;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$400(Landroid/hardware/Camera;)Landroid/hardware/Camera$GestureEvent;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$600(Landroid/hardware/Camera;)Landroid/hardware/Camera$SceneDectetionCallback;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$900(Landroid/hardware/Camera;)Landroid/hardware/Camera$PreviewCallback;
    .locals 1
    .param p0, "x0"    # Landroid/hardware/Camera;
...
.method static synthetic access$902(Landroid/hardware/Camera;Landroid/hardware/Camera$PreviewCallback;)Landroid/hardware/Camera$PreviewCallback;
    .locals 0
    .param p0, "x0"    # Landroid/hardware/Camera;
